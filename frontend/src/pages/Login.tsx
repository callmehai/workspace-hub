    ...
    <div className="relative flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950 p-6 font-sans text-slate-900 dark:text-slate-100">
      ...
      <div className="w-full max-w-[404px]">
        ...
        <div className="rounded-[14px] border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 p-7 shadow-sm">
          <h1 className="mb-1 text-[22px] font-semibold text-slate-900 dark:text-slate-100">
            {t("login.title")}
          </h1>
          ...
          <form onSubmit={handleLogin} noValidate>
            <label
              htmlFor="email"
              className="mb-1.5 block text-[13px] font-medium text-slate-900 dark:text-slate-200"
            >
              {t("login.email")}
            </label>
            <input
            ...
            <label
              htmlFor="password"
              className="mb-1.5 mt-3.5 block text-[13px] font-medium text-slate-900 dark:text-slate-200"
            >
              {t("login.password")}
            </label>
            <input
