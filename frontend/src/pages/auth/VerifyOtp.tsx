    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-6 font-sans text-gray-900">
      <div className="w-full max-w-[404px]">
        ...
        <div className="rounded-[14px] border border-gray-200 bg-white p-7 shadow-sm">
          <h1 className="mb-1 text-[22px] font-semibold text-gray-900">Xác minh số điện thoại</h1>
          ...
          <form onSubmit={handleVerify} noValidate>
            <label htmlFor="otp" className="mb-1.5 block text-[13px] font-medium text-gray-900">Mã OTP</label>
            <input
              id="otp"
              inputMode="numeric"
              maxLength={6}
              ...
              placeholder="••••••"
              className="h-[38px] w-full rounded-lg border border-gray-300 px-3 text-center text-lg tracking-[0.4em] outline-none transition focus:border-brand-500 focus:ring-2 focus:ring-brand-500/30"
            />
