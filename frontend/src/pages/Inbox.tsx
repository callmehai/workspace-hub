...
export const Inbox = () => {
  return (
    <div className="h-full flex flex-col md:flex-row overflow-hidden bg-dark-900">
      {/* Left Column - List */}
      <div className="w-full md:w-5/12 lg:w-4/12 flex flex-col border-r border-dark-600 bg-dark-800 shrink-0">
        <div className="p-4 border-b border-dark-600 flex items-center space-x-2 overflow-x-auto hide-scrollbar">
          <button className="flex items-center space-x-1.5 px-3 py-1.5 bg-dark-700 hover:bg-dark-600 text-gray-300 rounded-md text-sm border border-dark-600 transition-colors">
            <Filter className="w-4 h-4" />
            <span>Filter</span>
          </button>
          <div className="h-4 border-l border-dark-600 mx-1"></div>
          ...
          <button className="px-3 py-1.5 text-gray-400 hover:text-gray-200 hover:bg-dark-700 rounded-md text-sm font-medium transition-colors whitespace-nowrap">
            Unread
          </button>
          <button className="px-3 py-1.5 flex items-center space-x-1.5 text-gray-400 hover:text-gray-200 hover:bg-dark-700 rounded-md text-sm font-medium transition-colors whitespace-nowrap">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider bg-dark-800/50 backdrop-blur sticky top-0">
            Today
          </div>
          
          <div className="divide-y divide-dark-600">
            {/* Item 1 - Active */}
            <div className="p-4 bg-brand-500/5 hover:bg-dark-700 transition-colors cursor-pointer group flex gap-3 border-l-2 border-brand-500">
              <div className="mt-1">
                <input type="checkbox" className="w-4 h-4 rounded border-dark-500 bg-dark-800 checked:bg-brand-500 focus:ring-brand-500/30" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center space-x-2 text-xs text-gray-400">
                    <span className="font-medium text-gray-300 bg-dark-600 px-1.5 py-0.5 rounded text-[10px]">GH-104</span>
                    <span>•</span>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-dark-600 text-gray-300 border border-dark-500">
                    bug
                  </span>
                </div>
              </div>
            ...
            {/* Item 2 */}
            <div className="p-4 hover:bg-dark-700 transition-colors cursor-pointer group flex gap-3 border-l-2 border-transparent">
              <div className="mt-1">
                <input type="checkbox" className="w-4 h-4 rounded border-dark-500 bg-dark-800 checked:bg-brand-500 focus:ring-brand-500/30" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center space-x-2 text-xs text-gray-400">
                    <span className="font-medium text-gray-300 bg-dark-600 px-1.5 py-0.5 rounded text-[10px]">SL-Msg</span>
                    <span>•</span>
                    <span>#design-system</span>
                  </div>
                  <span className="text-xs text-gray-500">1h ago</span>
                </div>
                <h4 className="text-sm font-semibold text-gray-200 mb-1 truncate group-hover:text-brand-400 transition-colors">New token architecture review</h4>
                <p className="text-sm text-gray-400 line-clamp-2 mb-2 leading-relaxed">
            ...
            <div className="p-4 hover:bg-dark-700 transition-colors cursor-pointer group flex gap-3 border-l-2 border-transparent">
              ...
              <div className="flex-1 min-w-0 opacity-60 hover:opacity-100 transition-opacity">
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center space-x-2 text-xs text-gray-400">
                    <span className="font-medium text-gray-300 bg-dark-600 px-1.5 py-0.5 rounded text-[10px]">JIR-892</span>
                    <span>•</span>
                    <span>Frontend Team</span>
                  </div>
                  <span className="text-xs text-gray-500">2h ago</span>
                </div>
                <h4 className="text-sm font-semibold text-gray-400 line-through mb-1 truncate">Implement dark mode toggle in navbar</h4>
      ...
      <div className="flex-1 flex flex-col bg-dark-900 min-w-0">
        {/* Toolbar */}
        <div className="h-14 border-b border-dark-600 flex items-center justify-between px-6 shrink-0">
          <div className="flex items-center space-x-4">
            <button className="text-gray-400 hover:text-white transition-colors" title="Mark as done">
              <Check className="w-5 h-5" />
            </button>
            <button className="text-gray-400 hover:text-white transition-colors" title="Snooze">
              <Clock className="w-5 h-5" />
            </button>
            <div className="h-4 border-l border-dark-600"></div>
            <div className="flex items-center space-x-1.5 text-sm text-gray-400 bg-dark-800 px-2 py-1 rounded cursor-pointer hover:bg-dark-700 transition-colors">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto p-8">
            ...
            <div className="flex items-center space-x-3 mb-8 text-sm text-gray-400">
              ...
              <span className="font-medium text-gray-200">Sarah Chen</span>
              <span>opened 10 minutes ago</span>
            </div>

            <div className="flex gap-8 border-b border-dark-600 pb-6 mb-6 text-sm">
              <div>
              ...
              <div>
                ...
                <button className="flex items-center space-x-1.5 text-gray-400 hover:text-gray-200 transition-colors">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="rounded-lg overflow-hidden border border-dark-600 bg-[#1e1e1e] font-mono text-sm shadow-xl">
                <div className="flex items-center px-4 py-2 border-b border-dark-600 bg-dark-800">
