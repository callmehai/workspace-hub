...
export function CalendarGuestNotificationDialog({
  ...
  const message = hasAdded && hasRemoved
    ? t('calendar.sendGuestUpdateAddedRemoved', { addedCount, removedCount })
    : hasRemoved
      ? t('calendar.sendGuestUpdateRemoved', { removedCount })
      : t('calendar.sendGuestUpdateAdded', { addedCount });
        ...
        <div className="flex gap-4 p-5">
          ...
          <div className="min-w-0 flex-1 pt-0.5">
            <h3 id="calendar-guest-notification-title" className="text-[15px] font-semibold text-slate-900 dark:text-slate-100">
              {t('calendar.sendGuestUpdateTitle')}
            </h3>
