...
import { ContactProfileForm, normalizeProfile } from './ContactProfileForm';
...
export function ContactDetailPanel({
  ...
  const name = contact ? displayNameFrom(contact) : '';
