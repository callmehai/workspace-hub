...
public interface IGmailGateway
{
    ...
    Task<GmailMessageList> ListMessageIdsAsync(Connection connection, string? pageToken, int maxResults, IReadOnlyList<string>? labelIds = null, CancellationToken ct = default);
