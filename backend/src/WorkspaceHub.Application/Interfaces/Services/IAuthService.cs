...
{
    /// <summary>SCRUM-64: tạo user (EmailVerified=false) + gửi OTP qua email. KHÔNG phát token — chờ verify.</summary>
    ...
    /// <summary>SCRUM-64: verify OTP → set EmailVerified=true → phát JWT (đăng nhập luôn).</summary>
