...
public class GmailSyncServiceTests
{
    ...
    public async Task FullSync_WhenCursorNull_CreatesAllItems()
    {
        ...
        _gatewayMock.Setup(m => m.ListMessageIdsAsync(connection, null, It.IsAny<int>(), It.IsAny<IReadOnlyList<string>?>(), It.IsAny<CancellationToken>()))
    ...
    public async Task IncrementalSync_WhenNotExpired_CallsHistoryAndCreatesItems()
    {
        ...
        _gatewayMock.Verify(m => m.ListMessageIdsAsync(It.IsAny<Connection>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<IReadOnlyList<string>?>(), It.IsAny<CancellationToken>()), Times.Never);
    ...
    public async Task IncrementalSync_WhenExpired_FallsBackToFullSync()
    {
        ...
        _gatewayMock.Verify(m => m.ListMessageIdsAsync(It.IsAny<Connection>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<IReadOnlyList<string>?>(), It.IsAny<CancellationToken>()), Times.AtLeastOnce);
