...
public class ItemServiceTests
{
    ...
    public async Task GetItemsAsync_FolderIdBelongsToAnotherUser_ReturnsEmptyResult()
    {
        ...
        _repoMock.Verify(r => r.GetPagedAsync(
            ...
            It.IsAny<IReadOnlyList<ItemType>?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<IReadOnlyList<Guid>?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<Guid?>(), It.IsAny<string?>(),
