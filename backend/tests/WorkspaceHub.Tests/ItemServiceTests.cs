...
public class ItemServiceTests
{
    ...
    [Fact]
    public async Task GetItemsAsync_ClampsLimitTo200Max()
    {
    ...
    public async Task GetItemsAsync_PassesAllFiltersToRepository()
    {
        ...
        _repoMock
            .Setup(r => r.GetPagedAsync(
                ...
                true, "report", null, null, null, null, null, null, null, null, null, 2, 10, It.IsAny<CancellationToken>()))
            .ReturnsAsync((new List<Item>().AsReadOnly(), 0, new Dictionary<string, int>()));
        ...
        _repoMock.Verify(r => r.GetPagedAsync(
            ...
            It.Is<IReadOnlyList<ItemStatus>>(s => s.SequenceEqual(new[] { ItemStatus.Doing })),
            It.Is<IReadOnlyList<ItemType>>(ty => ty.SequenceEqual(new[] { ItemType.Email })),
            true, "report", null, null, null, null, null, null, null, null, null, 2, 10, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task GetItemsAsync_FolderIdBelongsToAnotherUser_ReturnsEmptyResult()
    {
        ...
        _repoMock.Verify(r => r.GetPagedAsync(
            ...
            It.IsAny<IReadOnlyList<ItemType>?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<IReadOnlyList<Guid>?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<Guid?>(), It.IsAny<DateTime?>(), It.IsAny<DateTime?>(), It.IsAny<string?>(), It.IsAny<string?>(),
