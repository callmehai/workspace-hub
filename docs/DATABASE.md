...
Không đổi cấu trúc.
- Tags (UserId, Name không unique toàn hệ thống — **nhưng unique trong 1 user**, enforced ở service layer SCRUM-70; Color). CRUD: `GET/POST /api/tags`, `PUT/DELETE /api/tags/{id}`. Cascade User→Tags→TagAssignments.
