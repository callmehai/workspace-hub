...
| SCRUM-73 | **[BE+FE] Email Drafts** — Tạo, Cập nhật, Gửi và Xoá nháp (Trash) qua Gmail; tự động lưu nháp debounced 2.0s; hỗ trợ inline reply draft và compose draft độc lập | Vũ | — | 🔄 In Progress — Backend API & Integration completed (Create/Update/Send/Discard endpoints, validation, and Gateway support). |
