...
| SCRUM-73 | **[BE+FE] Email Drafts** — Tạo, Cập nhật, Gửi và Xoá nháp (Trash) qua Gmail; tự động lưu nháp debounced 2.0s; hỗ trợ inline reply draft và compose draft độc lập | Vũ | — | ✅ Done — Backend endpoints, frontend compose page integration, and inline reply draft auto-save & discard are fully implemented and verified. |
