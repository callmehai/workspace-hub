...
| SCRUM-82 | **[FE] Calendar workspace view (Tháng / Tuần)** — route `/calendar`, grid Tháng+Tuần, drag event, overlay Scheduled/Jira, view switcher, modal editor cơ bản | Vũ | ✅ Done — `d3c501d`, `7a37694`, `a1ba25a`. **Hotfix 2026-07-19:** day/week view dùng time-grid 00:00→24:00 để xem/đặt lịch đầy đủ ngoài giờ hành chính. |
