...
| SCRUM-82 | **[FE] Calendar workspace view (Tháng / Tuần)** — route `/calendar`, grid Tháng+Tuần, drag event, overlay Scheduled/Jira, view switcher, modal editor cơ bản | Vũ | ✅ Done — `d3c501d`, `7a37694`, `a1ba25a`. **Hotfix 2026-07-19:** day/week view dùng time-grid 00:00→24:00; Calendar hỗ trợ lọc Google Calendar account khi multi-connection, tạo event mặc định theo account đang lọc, và gộp bản sao cùng event ở "Tất cả tài khoản", ưu tiên bản organizer/owner. |
